...
line = ""
parser = argparse.ArgumentParser(description='joins 2 lists of records using id, contig or location as key.')
...
try:
    ...
    for line in bioutils.readRecords(fh, args.sep.decode("string_escape")):
        ...
        if key != None and key not in records:
            bioutils.printRecord(key, value, args.sep, idType[1])         

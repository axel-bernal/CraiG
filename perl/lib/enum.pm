...
use Carp;
use vars qw($VERSION);
$VERSION = do { my @r = (q$Revision: 1.1.1.1 $ =~ /\d+/g); sprintf '%d.%03d'.'%02d' x ($#r-1), @r};
...
=head1 HISTORY
  ...
  $Log: enum.pm,v $
  Revision 1.1.1.1  2007/06/25 18:56:40  abernal
  Imported sources

  Revision 1.1.1.1  2005/11/10 21:55:38  abernal
  init craig

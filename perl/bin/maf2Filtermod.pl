...
use lib "/home/abernal/Applications/Contrib/bioperl/lib/perl5/site_perl/5.8.8/";
...
#        print "\tinformant ", $startI, " ", $endI, "\n";
        ...
        for(my $i = 1; $i < scalar(@each_seq); $i++) {
            ...
            if($inf ne "rheMac2" && $inf ne "rn4" &&
               $inf ne "sorAra1" && $inf ne "tetNig1" &&
               $inf ne "tupBel1" && $inf ne "xenTro2") {
                next;
            }

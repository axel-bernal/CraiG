...
namespace lless {
    ...
    void Core::initParamsFromLog(GlobalVector &finalParams,
                                 const char *logFile, int &iteration,
                                 int &accumIterations,
                                 int addedFeatures) {
    ...
    void Core::storeParams(const char *paramsFile, int iteration,
                           GlobalVector *avg) {
    ...
    void Core::storeLog(const char *logFile, int iteration,
                        int accumIterations) {
    ...
    void Core::storeIteration(const char *paramsFile, int iteration,
                              int accumIterations,
                              GlobalVector *avg,
                              bool saveLog) {

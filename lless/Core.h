...
namespace lless {
  ...
  class Core {
   ...
   public:
    ...
    void storeParams(char *paramsFile, int iteration,
                     GlobalVector *avg);
    void storeLog(char *paramsFile, int iteration,
                  int accumIterations);
    void storeIteration(char *paramsFile, int iteration,
                        int accumIterations,
                        GlobalVector *avg,
			bool saveLog = true);
